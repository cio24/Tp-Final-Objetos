...
import com.example.acgallery.Controller.Adapters.ThumbnailsAdapters.FolderThumbnailAdapter;
import com.example.acgallery.Model.Composite.Folder;
import com.example.acgallery.Model.Filters.FolderFilter;
import com.example.acgallery.Model.Filters.FileFilter;
import com.example.acgallery.Model.Filters.TrueFilter;
import com.example.acgallery.R;
import com.example.acgallery.Model.Comparators.CompoundComparator;
import com.example.acgallery.Model.Comparators.NameComparator;
import com.example.acgallery.Model.Comparators.RecentDateComparator;
import com.example.acgallery.Model.Comparators.FoldersFirstComparator;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.order_by_name_op:
                folderToShow.sort(new CompoundComparator(new FoldersFirstComparator(), new NameComparator()));
            ...
            case R.id.order_by_date_op:
                folderToShow.sort(new CompoundComparator(new FoldersFirstComparator(),new RecentDateComparator()));
                ActivitiesHandler.sendData("folderToShow",folderToShow);
                ActivitiesHandler.changeActivity(this, FolderThumbnailsActivity.class);
                return true;
